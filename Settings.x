        ...
        selectBlock:^BOOL (YTSettingsCell *innerCell, NSUInteger innerArg1) {
            ...
            [appearanceRows addObject:[self pageItemWithTitle:LOC(@"Presets")
                ...
                selectBlock:^BOOL(YTSettingsCell *presetCell, NSUInteger presetArg1) {
                    ...
                    [self themeAddPresetRowWithName:@"Afterglow" titleDescription:@"Charcoal glass with ember-orange controls and a real dusk glow." overlay:[UIColor colorWithRed:1.00 green:0.90 blue:0.78 alpha:1.0] tabIcons:[UIColor colorWithRed:0.99 green:0.63 blue:0.32 alpha:1.0] seekBar:[UIColor colorWithRed:0.97 green:0.49 blue:0.21 alpha:1.0] bg:[UIColor colorWithRed:0.07 green:0.07 blue:0.09 alpha:1.0] textP:[UIColor colorWithRed:0.98 green:0.95 blue:0.90 alpha:1.0] textS:[UIColor colorWithRed:0.70 green:0.62 blue:0.54 alpha:1.0] nav:[UIColor colorWithRed:0.12 green:0.11 blue:0.12 alpha:1.0] accent:[UIColor colorWithRed:0.94 green:0.44 blue:0.18 alpha:1.0] gradientStart:[UIColor colorWithRed:0.16 green:0.15 blue:0.17 alpha:1.0] gradientEnd:[UIColor colorWithRed:0.34 green:0.19 blue:0.11 alpha:1.0] toRows:presetRows settingsVC:settingsViewController];
